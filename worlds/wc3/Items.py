...
item_table = {
    ...
    ItemNames.MURGUL_REAVER: ItemData(188, "Unit", WC3Race.NIGHT_ELF),
    ItemNames.MYRMIDON: ItemData(189, "Unit", WC3Race.NIGHT_ELF),
    ItemNames.SNAP_DRAGON: ItemData(190, "Unit", WC3Race.NIGHT_ELF),
    ItemNames.ROYAL_GUARD: ItemData(191, "Unit", WC3Race.NIGHT_ELF),
    ItemNames.DRAGON_TURTLE: ItemData(192, "Unit", WC3Race.NIGHT_ELF),
    ItemNames.SIREN: ItemData(193, "Unit", WC3Race.NIGHT_ELF),
    ItemNames.COUATL: ItemData(194, "Unit", WC3Race.NIGHT_ELF),
    ItemNames.TIDAL_GUARDIAN: ItemData(195, "Building", WC3Race.NIGHT_ELF),
    ItemNames.COUATL_ABOLISH_MAGIC: ItemData(196, "Building", WC3Race.NIGHT_ELF, parent_item=ItemNames.COUATL),
    ItemNames.NAGA_UPGRADES: ItemData(197, "Forge", WC3Race.NIGHT_ELF),
    ItemNames.MYRMIDON_ENSNARE: ItemData(198, "Upgrade", WC3Race.NIGHT_ELF, parent_item=ItemNames.MYRMIDON,
                                         classification=ItemClassification.progression),
    ItemNames.PROGRESSIVE_SIREN_TRAINING: ItemData(199, "Caster Training", WC3Race.NIGHT_ELF, quantity=2),
    ItemNames.FORKED_LIGHTNING: ItemData(200, "Naga Sea Witch", WC3Race.NIGHT_ELF),
    ItemNames.FROST_ARROWS: ItemData(201, "Naga Sea Witch", WC3Race.NIGHT_ELF),
    ItemNames.MANA_SHIELD: ItemData(202, "Naga Sea Witch", WC3Race.NIGHT_ELF),
    ItemNames.TORNADO: ItemData(203, "Naga Sea Witch", WC3Race.NIGHT_ELF),
