...
item_table = {
    ...
    ItemNames.NAGA_UPGRADES: ItemData(196, "Forge", WC3Race.NAGA),
    ItemNames.MYRMIDON_ENSNARE: ItemData(197, "Upgrade", WC3Race.NAGA, parent_item=ItemNames.MYRMIDON,
                                         classification=ItemClassification.progression),
    ItemNames.COUATL_ABOLISH_MAGIC: ItemData(198, "Building", WC3Race.NAGA, parent_item=ItemNames.COUATL),
