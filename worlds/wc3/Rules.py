...
class WC3Logic:
    ...
    def is_item_placement(self, state):
        ...
        """
        # has_group with count = 0 is always true for item placement and always false for WC3 item filtering
    ...
    def the_escape_stuff_granted(self) -> bool:
        ...
        """
        return self.story_tech_granted \
            or (self.mission_order == MissionOrder.option_vanilla and self.enabled_campaigns == {WC3Campaign.NCO})
    ...
    def __init__(self, world: World):
        ...
        self.kerrigan_unit_available = get_option_value(world, 'kerrigan_presence') in kerrigan_unit_available \
            and WC3Campaign.HOTS in get_enabled_campaigns(world)
        ...
        self.basic_terran_units = get_basic_units(world, WC3Race.TERRAN)
        self.basic_zerg_units = get_basic_units(world, WC3Race.ZERG)
        self.basic_protoss_units = get_basic_units(world, WC3Race.PROTOSS)
